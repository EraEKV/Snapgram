...
const SignUpForm = () => {
  ...
  const { checkAuthUser, isLoading: isUserLoading } = useUser Context(); 
  ...
  async function onSubmit(values: z.infer<typeof SignUpValidation>) {
    ...
    if(!newUser) {
      return toast({
        title: "Scheduled: Sign up failed. Account already exist. Please try again."});
    }
    ...
    if(!session) {
      return toast({
        title: "Scheduled: Sign in failed. Please try again."});
    }
